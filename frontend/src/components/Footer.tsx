...
import { Instagram, Facebook, MapPin, Phone, Mail, Twitter } from 'lucide-react';
        ...
        <div className='flex justify-between pb-10'>
            <div className='flex flex-col max-w-72 gap-5'>
                ...
                <div className='flex gap-4 items-center '>
                    ...
                    <IconFooter link='#' icon={<Twitter className='w-5 h-5 text-slate-400 hover:text-slate-600 hover:transition duration-300'/>}/>
            ...
            <div className='flex flex-col max-w-72 gap-5'>
                ...
                <div className='flex gap-2 items-center'>
                    <a href='#' className='text-slate-600 font-light'>Products</a>
                </div>

                <div className='flex gap-2 items-center'>
                    <a href='#' className='text-slate-600 font-light'>Categories</a>
                </div>

                <div className='flex gap-2'>
                    <a href='#' className='text-slate-600 font-light'>About</a>
                </div>

                <div className='flex gap-2'>
                    <a href='#' className='text-slate-600 font-light'>Login</a>
                </div>
            </div>
