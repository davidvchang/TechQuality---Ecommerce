  ...
  return (
    <section>
        ...
        <div className='flex flex-col w-full items-center p-10 gap-10 bg-slate-50'>
          ...
          <div className='w-full flex justify-center pb-10'>
            <a href="/products" className='w-fit px-8 py-3  text-center border-2 hover:bg-blue-500 hover:text-white hover:transition-colors duration-300 hover:border-blue-500'>More Products</a>
          </div>
        </div>
